...
ENDPOINT_TOKEN = "userpicontraraspberrypi"       # Paste endpoint token
APPLICATION_VERSION = "c66o1e5ah5mmh3hsl6c0-v1"  # Paste application version
...
class KaaClient:
    ...
    def compose_data_sample(self,temp,hum,bat,vol):
        return json.dumps([
            {
...
def kaacloud(temp,hum,bat,vol):
    ...
    payload = kaa_client.compose_data_sample(temp,hum,bat,vol)
